...
input_csv = "example_data/test_aa_8aa_logits.csv"  # Input CSV file path (generated by bcepre_predict_logits.py)
...
output_csv = "predictions/test_aa_8aa_logits_probabilities_with_aa.csv"  # Output CSV file path
